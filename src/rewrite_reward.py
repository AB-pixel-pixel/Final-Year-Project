...
GLOBAL_LLM = AIRS_LLM(large_model_server_ip_port = "http://192.168.31.81:2048/api/generate")# "http://127.0.0.1:8040/api/generate")
...
if __name__ == "__main__":
    ...
    for scene in scene_list:
        ...
        if scene_id == 21 or scene_id == 22 or scene_id == 23 or scene_id == 24:
            continue
